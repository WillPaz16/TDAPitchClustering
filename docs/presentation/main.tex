...
\title{The Intersection of Topological Data Analysis’s Mapper Algorithm and Gradient-Boosted Decision Tree Pitch-Level MLB Data} % Replace X with the appropriate number
